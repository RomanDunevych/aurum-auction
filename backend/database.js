...
db.serialize(() => {
    ...
    db.run(`CREATE TABLE IF NOT EXISTS Lots (id INTEGER PRIMARY KEY, title TEXT, description TEXT, start_price REAL, current_price REAL, image_url TEXT, category_id INTEGER, status_id INTEGER, end_time DATETIME)`);
